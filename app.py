...
with tab1:
    ...
    if pf > 0:
        ...
        # 判定（一般的に1.5以下を良とする場合が多いですが、資料の数値 1.191 に基づく）
        is_good = vswr < 1.5
...
with tab2:
    ...
    if freq > 0:
        ...
        st.markdown("---")
        st.write("### 同軸ケーブル推奨長")
        st.info("反射波の影響を抑えるため、1/2λの整数倍が推奨されます。") #[cite: 1]
